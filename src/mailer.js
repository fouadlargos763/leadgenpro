...
let transporter = {
    sendMail: async (options) => {
        console.warn('[Mailer Warning] No SMTP transport configured. Email was not sent:', options.to);
...
if (hasMailConfig) {
    ...
    console.log('[Mailer] SMTP Transport initialized successfully.');
} else {
    console.warn('[Mailer Warning] EMAIL_PASS or SMTP details missing. Using simulated logging transporter.');
}
